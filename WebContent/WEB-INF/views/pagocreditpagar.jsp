		...
		<form>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputEmail4">Nombre o Apellido</label> <input
			...
			<div class="form-group col-md-7">
				<label for="inputEmail4">Ingrese el monto a pagar</label> <input
					type="text" class="form-group" placeholder="Monto a pagar">
				<a href="pagocreditsecu.html"><button type="button"
